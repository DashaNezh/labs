...
static const char *const yytname[] =
{
  ...
  "DIV", "LESS", "UMINUS", "MORE", "EQUALS", "LPAREN", "RPAREN", "LBRACE",
  "RBRACE", "SEMICOLON", "COMMA", "IF", "ELSE", "WHILE", "NUMBER",
  "$accept", "commands", "command", "condition", "expr", YY_NULLPTR
};
...
{
      -8,     1,    -8,     6,     6,    -7,     8,    -8,    -8,    57,
       3,    39,     6,     6,     6,     6,     6,     6,    -8,    -8,
      52,    49,    53,    57,    57,    57,    57,    18,     6,     6,
       6,     6,    21,     6,    57,    57,    57,    57,     6,    19,
      35,    -8,    -8
};
...
{
       9,     2,    10,    11,    12,     3,    14,    15,    16,    17,
       3,    18,     4,    23,    24,    25,    26,     4,     5,    13,
       6,     7,    14,    15,    16,    17,     7,    34,    35,    36,
      37,    33,    39,    41,    38,    22,     0,    40,    14,    15,
      16,    17,    14,    15,    16,    17,     0,     0,     0,    42,
       0,    19,    14,    15,    16,    17,    29,     0,    30,    31,
      14,    15,    16,    17,    27,    32,     0,    28,    28
};

static const yytype_int8 yycheck[] =
{
       1,     0,     3,     4,    11,     4,     3,     4,     5,     6,
       4,     8,    11,    14,    15,    16,    17,    11,    17,    11,
      19,    20,     3,     4,     5,     6,    20,    28,    29,    30,
      31,    13,    33,    14,    13,    13,    -1,    38,     3,     4,
       5,     6,     3,     4,     5,     6,    -1,    -1,    -1,    14,
      -1,    12,     3,     4,     5,     6,     7,    -1,     9,    10,
       3,     4,     5,     6,    12,    12,    -1,    15,    15
};
...
{
       0,    22,     0,     4,    11,    17,    19,    20,    23,    25,
      25,    25,    11,    11,     3,     4,     5,     6,     8,    12,
      24,    25,    24,    25,    25,    25,    25,    12,    15,     7,
       9,    10,    12,    13,    25,    25,    25,    25,    13,    25,
      25,    14,    14
};
...
#line 1153 "parser.tab.c"
  ...
  case 4: /* command: IF LPAREN condition RPAREN LBRACE expr RBRACE  */
#line 74 "parser.y"
                                                       { (yyval.a) = newFlow('I', (yyvsp[-4].a), (yyvsp[-1].a), NULL);  }
#line 1159 "parser.tab.c"
    break;

  case 5: /* command: WHILE LPAREN condition RPAREN LBRACE expr RBRACE  */
#line 75 "parser.y"
...
#line 1171 "parser.tab.c"
  ...
  case 7: /* condition: expr LESS expr  */
#line 79 "parser.y"
                          { (yyval.a) = newAst('<', (yyvsp[-2].a), (yyvsp[0].a)); }
#line 1177 "parser.tab.c"
    break;

  case 8: /* condition: expr MORE expr  */
#line 80 "parser.y"
                 { (yyval.a) = newAst('>', (yyvsp[-2].a), (yyvsp[0].a)); }
#line 1183 "parser.tab.c"
    break;

  case 9: /* condition: expr EQUALS expr  */
#line 81 "parser.y"
                   { (yyval.a) = newAst('=', (yyvsp[-2].a), (yyvsp[0].a)); }
#line 1189 "parser.tab.c"
    break;

  case 10: /* condition: condition SEMICOLON expr  */
#line 82 "parser.y"
                           {(yyval.a) = newAst('w', (yyvsp[-2].a), (yyvsp[0].a));}
...
#line 1231 "parser.tab.c"
  ...
  case 17: /* expr: MINUS expr UMINUS  */
#line 92 "parser.y"
                        { (yyval.a) = newAst('M', (yyvsp[-1].a), NULL);  }
